...
int aAnimObject::init2( FitIniFile* file, const char* blockName, float resXFactor, float resYFactor, DWORD neverFlush )
{
	aObject::init2( file, blockName, neverFlush, resXFactor, resYFactor ); //magic 18022012
	...
	if ( NO_ERR == file->seekBlock( animName ) )
		animInfo.init2( file, "", resXFactor, resYFactor ); //magic 18022012
