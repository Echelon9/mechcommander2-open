...
long GameVisibleVertices = 60; //magic 18022011 was 30;
bool useLeftRightMouseProfile = true;

float MaxMinUV = 8.0f;

//magic values below changed 30122010
unsigned long systemHeapSize = 524288000;//65535000;
unsigned long guiHeapSize = 8192000;//1023999;
unsigned long tglHeapSize = 209715200;//32767000;
bool		  GeneralAlarm = 0;
...
char *SpecialtySkillsTable[NUM_SPECIALTY_SKILLS] = {
	...
	"SRMSpecialist",
	"SmallArmsSpecialist",
	//Magic78 "SensorProfileSpecialist",
...
void __stdcall InitializeGameEngine()
{
	...
	*/ //magic 02102011 disabled
	...
	MidLevelRenderer::InitializeClasses(16384*4,16384,0,0,true); //magic 18022011
	...
	gos_Free(effectsData); //magic 02102011
	...
	mcTextureManager->startVertices(3000000); //magic 29052012 was 500000
