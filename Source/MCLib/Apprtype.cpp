...
//---------------------------------------------------------------------------
// static Globals
//UserHeapPtr AppearanceTypeList::appearanceHeap = NULL; //magic 01102011X disabled
...
{
	//AppearanceTypeList::appearanceHeap->Free(name); //magic 01102011X disabled
	if (name) //magic 18032012
	{
		gos_Free(name); //magic 18032012
		name = NULL;
	}
}
...
void AppearanceTypeList::init (unsigned long heapSize)
{
	...
	//appearanceHeap->init(heapSize,"APPEAR",true); //magic 17032011 crush on mech purchase press
	*/ //magic 01102011X disabled
...
//magic 04082011 ovde treba da ide 
...
void AppearanceTypeList::destroy (void)
{
	...
	//delete appearanceHeap; //magic 01102011X disabled
	//appearanceHeap = NULL; //magic 01102011X disabled
...
bool AppearanceTypeList::pointerCanBeDeleted (void *ptr)
{
	...
	return false;*/ //magic 01102011X disabled
	return true; //magic 01102011X
}
