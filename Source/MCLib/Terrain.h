...
#define	MAPCELL_DIM				3 //(always 3 - 3x3) increase will crush //magic 23022011
#define	MAX_MAP_CELL_WIDTH		720 // (map size 120x120 - 120*120/20 or NOT)
//#define	MAX_MAP_CELL_WIDTH		2000 // (map size 200x200 - 200*200/20) //magic 23022011
#define TACMAP_SIZE				256.f //128.f //magic 26022011 no difference with 256
...
class Terrain
{
	...
	protected:
		...
		//unsigned long							terrainHeapSize; //magic 01102011X3 disabled
	...
	public:
		...
		//static UserHeapPtr						terrainHeap;				//Heap used for terrain. //magic 01102011X3 disabled
