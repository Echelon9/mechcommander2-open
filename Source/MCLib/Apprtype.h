...
class AppearanceType
{
	...
	public:
		...
		//void* operator new (size_t memSize); //magic 01102011X disabled
		//void operator delete (void* treePtr); //magic 01102011X disabled
...
class AppearanceTypeList
{
	...
	public:
		...
		//static UserHeapPtr	appearanceHeap; //magix 01102011X disabled
