...
class TerrainColorMap
{
	...
	protected:
		...
		//UserHeapPtr				colorMapHeap; //magic 05112011 disabled
		//UserHeapPtr				colorMapRAMHeap; //magic 05112011 disabled
		//DWORD					*colorMapMem; //magic 05112011
	...
	public:
		...
		//void getColorMapData (DWORD* ourRAM, long index, long width, bool dd = false); //magic 06112011
