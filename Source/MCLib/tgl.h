...
//#define 	MAX_LIGHTS_IN_WORLD				512 //magic 02082011

#define 	TG_NODE_ID						25

#define		MAX_SCAN_LENGTH					40

#define 	MAX_NODES						256 //512 //256 //magic 04082011
...
class TG_VertexPool
{
	...
	public:
		...
		void init (DWORD maxVertices)
		{
			...
			tgVertexPool = new TG_Vertex[maxVertices]; //magic 03102011
...
class TG_GOSVertexPool
{
	...
	public:
		...
		void destroy (void)
		{
			...
			delete [] gVertexPool; //magic 03102011
			gVertexPool = nextVertex = NULL;
			totalVertices = numVertices = 0;
		}
		...
		void init (DWORD maxVertices)
		{
			...
			gVertexPool = new gos_VERTEX[maxVertices]; //magic 03102011
...
class TG_TrianglePool
{
	...
	public:
		...
		void destroy (void)
		{
			...
			delete [] trianglePool; //magic 03102011
			trianglePool = nextTriangle = NULL;
			totalTriangles = numTriangles = 0;
		}
		...
		void init (DWORD maxTriangles)
		{
			...
			trianglePool = new TG_Triangle[maxTriangles]; //magic 03102011
...
class TG_ShadowPool
{
	...
	public:
		...
		void destroy (void)
		{
			...
			delete [] tVertexPool; //magic 03102011
			tVertexPool = nextVertex = NULL;
			totalVertices = numVertices = 0;
		}
		...
		void init (DWORD maxVertices)
		{
			...
			tVertexPool = new TG_ShadowVertexTemp[maxVertices]; //magic 03102011
...
class TG_DWORDPool
{
	...
	public:
		...
		void init (DWORD maxTriangles)
		{
			...
			triPool = new DWORD[maxTriangles]; //magic 03102011
