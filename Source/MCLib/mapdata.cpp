...
/*
	...
	*/ //magic 05112011 disabled
	...
	mapMem = new PostcompVertex[(numVertices+1)]; //magic 05112011

	//MemoryPtr start = getHeapPtr();
	//MemoryPtr start = (MemoryPtr)new PostcompVertex[(numVertices+1)]; //magic 05112011
	MemoryPtr start = (MemoryPtr)mapMem; //magic 05112011
...
long MapData::update (void)
{
	...
	if (!blankVertex)
	{
		...
		blankVertex->textureData = (1<<16) + 1; //magic 05102012
