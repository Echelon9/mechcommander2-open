...
void Appearance::drawTextHelp (char *text, unsigned long color)
{
	...
	gos_TextSetAttributes (gosFontHandle, 0, gosFontScale, false, true, true, false);//magic 18022011
	...
	globalFloatHelp->setFloatHelp(text,moveHere,color,SD_BLACK,1.0f,true,true,false,false);//magic 18022011
}
