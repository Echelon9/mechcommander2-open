...
void tgaDecomp (DWORD* dest, DWORD* source, TGAFileHeader *tga_header, bool dd=false); //magic 06112011
...
void flipTopToBottom (DWORD* buffer, BYTE depth, long width, long height, bool dd=false); //magic 06112011
//---------------------------------------------------------------------------
#endif
