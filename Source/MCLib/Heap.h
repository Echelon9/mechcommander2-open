...
#define MAX_HEAPS		512 //256 //magic 26022011 512 no help with 180+ crush
//---------------------------------------------------------------------------
...
class HeapManager
{
	...
	protected:
		...
		MemoryPtr				heap;
		//HANDLE					heap; //magic 17032011
		//void					*heap;
		bool					memReserved;
		unsigned long   		totalSize; //magic 17032011 was unsigned long no good
		unsigned long   		committedSize; //magic 17032011 was unsigned long
...
//		void	ConstructBlkInfoLine (PVMQUERY pVMQ, LPTSTR szLine, int nMaxLen);
	...
	public:
		...
		//void* getHeapPtr (void); //magic 17032011
		operator MemoryPtr (void); //disabled magic 17032011
...
class UserHeap : public HeapManager
{
	...
	protected:
		...
		unsigned long		heapSize; //magic 17032011 was unsigned long
		bool				mallocFatals;
