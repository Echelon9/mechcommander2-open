...
class CraterManager
{
	...
	protected:
		...
		//HeapManagerPtr		craterPosHeap; //magic 05112011 disabled
		//UserHeapPtr			craterShpHeap; //magic 05112011 disabled
		
		//unsigned long		craterPosHeapSize; //magic 05112011 disabled
		//unsigned long		craterShpHeapSize; //magic 05112011 disabled
		...
		DWORD				craterTextures; //magic 07112011
	...
	public:
		...
		void init (void)
		{
			//craterPosHeap = NULL; //magic 05112011 disabled
			//craterShpHeap = NULL; //magic 05112011 disabled

			//craterPosHeapSize = craterShpHeapSize = 0; //magic 05112011 disabled
