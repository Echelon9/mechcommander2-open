...
class PacketFile : public File
{
	...
	public:
		...
		long writePacket (long packet, MemoryPtr buffer, long nbytes, unsigned char p_type = STORAGE_TYPE_RAW); //ANY_PACKET_TYPE); //magic 23022011
		long insertPacket (long packet, MemoryPtr buffer, long nbytes, unsigned char p_type = STORAGE_TYPE_RAW); //ANY_PACKET_TYPE); //magic 23022011
