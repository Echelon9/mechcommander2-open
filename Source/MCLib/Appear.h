...
class Appearance
{
	...
	public:
		...
		//void * operator new (size_t mySize); //magic 01102011X disabled
		//void operator delete (void * us); //magic 01102011X disabled
...
//magic 09092011 begin
		virtual void setObjectName (const char *objName) 
		{
		}
//magic 09092011 end
		...
		//magic 09112011
		virtual void setObjStatus (long oStatus, bool impassableWhenDestroyed)
		{
		}
		//magic 09112011

		//virtual long calcCellsCovered (Stuff::Vector3D& pos, short* cellList) {
		virtual long calcCellsCovered (Stuff::Vector3D& pos, long* cellList) { //magic 07032012
			return(0);
		}
		...
		virtual long markMoveMap (bool passable, long* lineOfSightRect, bool useheight = false, long* cellList = NULL) //magic 07032012
		{
			return(0);
		}
		...
		virtual bool toggleForestClump (void)
		{	
			return false;
		}
		//magic 26072011 end*/
