...
#define MC_MAX_TERRAIN_TXMS			6000 //3000 //magic 21022011

#define MC_MASK_NUM					14

#define MC_MAX_MIP_LEVELS			1 //1 magic 15022012-2 increase no good
...
#define END_CEMENT_TYPE				141 //59 //35 //26 //magic 22032012 last of new cement overlays in textures.fit
...
class TerrainTextures
{
	...
	protected:
		...
		//UserHeapPtr			tileHeap; //magic 18032012 disabled
		//UserHeapPtr			tileRAMHeap; //magic 18032012 disabled
	...
	protected:
		...
		long loadOverlayMemory2 (char *overlayName, MemoryPtr ourRam); //magic 21022012
	...
	public:
		...
		void init (void)
		{
			//tileHeap = NULL; //magic 18032012 disabled
			//tileRAMHeap = NULL; //magic 18032012 disabled
