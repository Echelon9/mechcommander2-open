...
class MapData : public HeapManager
{
	...
	protected:
		...
		int							hasSelection;
		PostcompVertexPtr			mapMem; //magic 05112011
	...
	public:
		...
		//void *operator new (size_t mySize); //magic 01102011X3 disabled
		//void operator delete (void *us); //magic 01102011X3 disabled
