...
MStringRepresentation::MStringRepresentation(const MStringRepresentation &str)
{
	...
	else
	{
		...
		//stringText = (char *)gos_Malloc(stringSize); //magic 26092011
	...
	)
{
	...
	if (totalLen == 0)
   {
	...
	//temp.stringText = (char *)gos_Malloc(temp.stringSize); //magic 26092011
   ...
   )
{
   ...
   size_t string_length;
	...
	if (string_length > 0)
	{
		...
		//char *ptr = (char *)gos_Malloc(string_length + 1); //magic 26092011
