...
class SoundSystem
{
	...
	protected:
		...
		//unsigned long		soundHeapSize; //magic 02102011 disabled
		//UserHeapPtr			soundHeap;  //magic 02102011 disabled
	...
	public:
		...
		void init (void)
		{
			...
			//soundHeapSize = 0; //magic 02102011 disabled
			//soundHeap = NULL; //magic 02102011 disabled
