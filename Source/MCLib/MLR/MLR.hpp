...
namespace MidLevelRenderer
{
	...
	struct Limits {
		...
		enum {
			Max_Number_Vertices_Per_Mesh = 8192, //4096, //2048, //1024, //magic 15022012
			Max_Number_Vertices_Per_Polygon = 128, //64, //32, //magic 15022012
			Max_Number_Of_Texture_Bits = 14,
			Max_Number_Textures = 1 << Max_Number_Of_Texture_Bits,
			Max_Number_Of_NGon_Vertices = 18, //9, //magic 15022012
	...
	void InitializeClasses(
		unsigned Max_Number_Vertices_Per_Frame = 65536, //32768, //16384, //8192, //magic 04082011
		unsigned Max_Number_Primitives_Per_Frame = 8192, //4096, //2048, //1024, //magic 04082011
		unsigned Max_Number_ScreenQuads_Per_Frame = 4096, //2048, //1024, //512, //magic 04082011
		unsigned Max_Size_Of_LightMap_MemoryStream = 131072, //65536, //32768 //magic 04082011
