...
class Mech3DAppearanceType: public AppearanceType
{
	...
	public:
		...
		static void disableAnimationLoading(void) //magic 04082011
		{
			animationLoadingEnabled = false;
		}
		//static enableAnimationLoading(void)
		static void enableAnimationLoading(void) //magic 04082011
		{
	...
	public:
		...
		void init (void) 
		{
			...
			//textureSide = 256;		//magic 04082011.
...
#define MAX_NODE_USED			16 //20 //magic 06082011 (10 u originalu, kad se stavi vece od 10 prouzrokuje pucanje posle quick loada u nekim misijama)
//-------------------------------------------------------------------------------
typedef struct _MechAppearanceData
{
	...
	long						nodeUsed[MAX_NODE_USED];				//Used to stagger the weapon nodes for firing.
	float						nodeRecycle[MAX_NODE_USED];			//Used for ripple fire to find out if the node has fired recently.
	//magic 20072011 end
...
class Mech3DAppearance: public ObjectAppearance
{
	...
	public:
		...
		virtual long getCurrentGestureGoal ()
		{
			return(currentStateGoal);
		}
		...
		virtual void fallForward (void);
		virtual void fallBackward (void);
		//magic 06092011 end	
		...
		virtual void setMechName( const char* pName )
		{
			...
			strcpy_s( mechName, pName );//magic 12092011
		}
		//magic 12092011 begin
		virtual void setObjectName (const char *objName); //magic 09092011
		//magic 12092011 end
...
typedef Mech3DAppearance *Mech3DAppearancePtr;
//-------------------------------------------------------------------------------
