...
//magic 02032011 begin
	const char** pGroups = (const char**)malloc( sizeof( const char *) * groupCount);//magic 02032011
//magic 02032011 end	
...
//magic 02032011 end

	{
...

		{
			...
			actionComboBoxItems.Append(MAKE_NEW_COMPONENT_SALVAGE); //magic 03092012
			EString tmpEStr;
...

		{
			...
			failureActionComboBoxItems.Append(MAKE_NEW_COMPONENT_SALVAGE); //magic 03092012
			EString tmpEStr;
