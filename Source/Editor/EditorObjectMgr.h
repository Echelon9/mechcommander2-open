...
public:
	...
	typedef EList< EditorObject*, EditorObject*>  BUILDING_LIST; //magic duplicate in private	// buildings on the map
	typedef EList< Unit*, Unit* > UNIT_LIST; //magic duplicate in private
