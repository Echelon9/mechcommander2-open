...
class LogisticsComponent
{
	public:
		...
		inline int getMaxWRange() const{ return maxWRange; }
		inline int getMinWRange() const{ return minWRange; }
		//magic 11022012 end
		...
		bool			isWeapon();
//		void			setComponentsInventory( LogisticsComponent iComponent );
