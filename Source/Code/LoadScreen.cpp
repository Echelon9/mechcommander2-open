...
//Magic 16022011 end
	...
	LoadScreen::changeRes( outFile ); //magic 18022012 this should go above 2 lines 
...
void LoadScreen::changeRes( FitIniFile& outFile )
{
	...
	if ( !progressBackground )
	{
		...
		//progressBackground = (TGAFileHeader*)(char *)gos_Malloc(size); //magic 26092011 
		...
		//progressTextureMemory = (TGAFileHeader*)(char *)gos_Malloc(size); //magic 26092011
		tgaFile.read( (unsigned char*)progressTextureMemory, tgaFile.fileSize() );

		mergedTexture = (TGAFileHeader*)new char[size];
		//mergedTexture = (TGAFileHeader*)(char *)gos_Malloc(size); //magic 26092011
		...
		//waitingForPlayersMemory = (TGAFileHeader*)(char *)gos_Malloc(size); //magic 26092011
...
void LoadScreenWrapper::update()
{
	...
	//magic 28092011 disabled 2 lines above
	...
	//if ( Environment.screenWidth == 1280 ) //magic 16092011
	if (( Environment.screenWidth == 800 ) || ( Environment.screenWidth == 1280 ) || ( Environment.screenWidth == 1440 ))//magic 16092011
		{
			enterScreen->update();
