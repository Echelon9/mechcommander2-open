...
//--------------------------------------------------------------------------------------
// Externs
//extern UserHeapPtr guiHeap; //magic 03102011 disabled
...
public:
	...
	public:
		...
		const char* getSuppVehicleNameFromID (long ID) { return controlGui.getSupVehicleNameFromID(ID); }//magic 31032011
		...
		void playMovie (char *filename)
		{
			...
			//controlGui.playMovie2(filename); //magic 18032012
		}
		...
		//Magic 81 begin
		void formations(Stuff::Vector3D* moveGoals, long numMovers, float ofsetAngle);
		Stuff::Vector3D relPositionToPoint (Stuff::Vector3D pointPos, float angle, float distance, unsigned long flags);
		int cycleFormations();
		//magic 27122010 begin
		void setTextMsg (long msgType, const char* msgText, long msgSeconds = 0);
		//magic 27122010 end
		//Magic 81 end
