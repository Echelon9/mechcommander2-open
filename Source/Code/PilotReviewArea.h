...
protected:
	...
	AttributeMeter		attributeMeters[4];
	static AttributeMeter*		s_attributeMeters[4];

	static aObject*		s_icons[9]; //magic 12042011 was 8
	static aText*		s_nameText;
	static aText*		s_missionText;
	static aText*		s_killsText;
	static long			s_itemCount;
	static aRect*		s_outline[9]; //magic 12042011 was 5

	static aText*		s_rankText;
	static aText*		s_gunneryText;
	static aText*		s_pilotingText;
	static aText*		s_sensorText;//Magic
	static aText*		s_jumpingText;//Magic
	static aRect*		s_area;
	...
	//aObject		icons[4];
	aObject		icons[5]; //magic 12042011
	aText		nameText;
	aText		missionText;
	aText		killsText;
	long			itemCount;
