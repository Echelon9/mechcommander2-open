...
class WeaponFireChunk {
	...
	public:
		...
		//void* operator new (size_t mySize); //magic 02102011 disabled

		//void operator delete (void* us); //magic 02102011 disabled
...
typedef struct _GameObjectData
{
	...
	unsigned long				cellPositionRow;	
	unsigned long				cellPositionCol;
	//magic 07032012 end
	long						d_vertexNum;		
	unsigned long				flags;				
...
class GameObject {
	...
	public:
		...
		//unsigned short				cellPositionCol;
		//magic 07032012 begin
		unsigned long				cellPositionRow;	//Cell RC position
		unsigned long				cellPositionCol;
		//magic 07032012 end
	...
	public:
		...
		void* operator new (size_t ourSize); //magic 25032012 disabled

		void operator delete (void *us); //magic 25032012 disabled
...
//magic 09092011 begin
		virtual void setName(const char *objName)
		{
		}
//magic 09092011 end
		...
		virtual float getResourcePoints(void) {
				return(0.0);
		}

		virtual bool addResourcePoints(long numAdd) {
				return(false);
		}

		virtual bool addRefitPoints(float pointsToAdd){
			return(false);
		}
		
		virtual float getTotalRefitPoints(void) {
			return(0.0);
		}

		//magic 05072011 end
		//magic 02082011 begin
		virtual float getResPoints(void) {
				return(0.0);
		}

		virtual bool addResPoints(float numAdd) 
		{
				return (false);
		}

		virtual float getTotalResPoints(void) {
			return(0.0);
		}
		//magic 02082011 end
