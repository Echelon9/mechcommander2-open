...
int KeyboardRef::init()
{
	...
	case 1920:
		...
		{
			path.init( artPath, "mcui_keyref_1921", ".fit" );
		}
		else
		{
			path.init( artPath, "mcui_keyref_1920", ".fit" );
		...
		break;
	case 1680:
		path.init( artPath, "mcui_keyref_1680", ".fit" );
		break;
	case 1440:
		path.init( artPath, "mcui_keyref_1440", ".fit" );
		break;
	//magic 16022011 end
	//magic 08022012 begin
	case 1366:												
		path.init( artPath, "mcui_keyref_1366", ".fit" );
		break;
	//magic 08022011 end
	default:
