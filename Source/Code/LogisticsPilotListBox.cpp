...
int LogisticsPilotListBoxItem::init( FitIniFile* file )
{
	...
	s_templateItem->icon.init( file, "Static0" ); //magic 12022011 ovde init icon
	setAnimation( *file, 2 );
...
void LogisticsPilotListBox::makeUVs( LogisticsPilot* pPilot, aObject& icon )
{
	...
	//long xIndex = index % 20; //magic 030322011
	//long yIndex = index / 20; //magic 030322011
	...
	//icon.setFileWidth(512.f); //magic 030322011
