...
#define ARMOR_HEAD_PERCENT						0.04f
#define ARMOR_CTORSO_PERCENT					0.16f
#define ARMOR_RTORSO_PERCENT					0.12f
#define ARMOR_LTORSO_PERCENT					0.12f
#define ARMOR_LARM_PERCENT						0.12f
#define ARMOR_RARM_PERCENT						0.12f
#define ARMOR_LLEG_PERCENT						0.11f
#define ARMOR_RLEG_PERCENT						0.11f
#define ARMOR_RCTORSO_PERCENT					0.03f
#define ARMOR_RLTORSO_PERCENT					0.03f
#define ARMOR_RRTORSO_PERCENT					0.03f
//---------------------------------------------------------------------------
