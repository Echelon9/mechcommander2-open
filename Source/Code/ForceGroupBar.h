...
class ForceGroupBar
{
	public:
		...
		//Magic 81 begin
		void formation (int formationID);
		void sortForceGroup ();
		Mover* getFirstOfSelection ();
		void rosterPlayerOrder (long* rosterOrder, int rosterCount);
		//long* rosterGroupOrder ();
		// Magic 81 end
