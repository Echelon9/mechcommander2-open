...
//		long				variant;						// Now we have three longs storing a bytes worth of data well done SJ
	...
	public:
		...
		//virtual long init2 (DWORD variantNum); //magic 19022012
		...
		void resetCurInternalPoints (float *internalArray);
		void resetCurArmorPoints (float *armorArray);
		//magic 05052012 end
		...
		float getArmorDamageFactor (void);
		float getInternalDamageFactor (void);
		//magic 25092012 end
};
