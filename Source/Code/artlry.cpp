...
void ArtilleryType::destroy (void) 
{
	if (explosionOffsetX) 
	{
		...
		delete [] explosionOffsetX; //magic 02102011
	...
	if (explosionOffsetY) 
	{
		...
		delete [] explosionOffsetY; //magic 02102011
	...
	if (explosionDelay) 
	{
		...
		delete [] explosionDelay; //magic 02102011
		explosionDelay = NULL;
	}
...
void Artillery::Save (PacketFilePtr file, long packetNum)
{
	...
	file->writePacket(packetNum,(MemoryPtr)&data,sizeof(ArtilleryData),STORAGE_TYPE_RAW); //magic 11032012
}
