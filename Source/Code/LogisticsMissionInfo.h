...
class LogisticsMissionInfo
{
	public:
		...
		int					getTopDropWeight() const { return topDropWeight; }
		void				incrementCBills(int amount) { CBills += amount; }
		void				decrementCBills(int amount) { CBills -= amount; }
		void				incrementDropWeight(int amount) { topDropWeight += amount; }//M
		void				decrementDropWeight(int amount) { topDropWeight -= amount; }//M
		int					incMaxDropWeight(int amount); //M
		int					decMaxDropWeight(int amount);//M
		//magic 02062012 begin
		int					setMaxDropWeight(int amount); //M
