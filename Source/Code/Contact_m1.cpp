...
void TeamSensorSystem::addContact (SensorSystemPtr sensor, MoverPtr contact, long contactIndex, long contactStatus) {
	...
	if ((contactStatus != CONTACT_NONE) && (contactStatus != CONTACT_VISUAL))
	MechWarrior::warriorList[contactInfo->teamSpotter[teamId]]->triggerAlarm(PILOT_ALARM_NEW_CONTACT,0);
}
