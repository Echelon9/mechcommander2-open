...
long GlobalCollisionAlert::init (unsigned long maxCollisionAlerts)
{
	...
	collisionAlerts = new CollisionAlertRecord[maxAlerts]; //magic 02102011
...
void GlobalCollisionAlert::destroy (void)
{
	...
	delete [] collisionAlerts; //magic 02102011
...
void * CollisionSystem::operator new (size_t mySize)
{
	...
	result = gos_Malloc(mySize); //magic 02102011
...
long CollisionSystem::init (FitIniFile *scenarioFile)
{
	...
	long result = collisionHeap->init(131071); //magic 27032011
	//long result = collisionHeap->init(65535,"0",true); //magic 27032011 no good crush the mission on load
