...
typedef struct _TerrainObjectDataOld : public GameObjectData
{
	float						damage;
	long						vertexNumber;
	long						blockNumber;
...
typedef struct _TerrainObjectData : public GameObjectData
{
	...
	GameObjectWatchID			powerSupply;
	//short						cellFootprint[4];
	long						cellFootprint[4]; //magic 07032012
	Stuff::Vector3D				vectorFootprint[4];
	/*short						numSubAreas0;
	short						numSubAreas1;
	short						subAreas0[MAX_SPECIAL_SUB_AREAS];
	...
	long						numSubAreas0;
	long						numSubAreas1;
	long						subAreas0[MAX_SPECIAL_SUB_AREAS];
	long						subAreas1[MAX_SPECIAL_SUB_AREAS];
	//magic 07032012 end
	unsigned char				listID;

	unsigned char				numCellsCovered;
	//short						cellsCovered[81];
	long						cellsCovered[161]; //magic 07032012
} TerrainObjectData;
...
class TerrainObject : public GameObject {
	...
	public:
		...
		void calcSubAreas (long numCells, long cells[MAX_GAME_OBJECT_CELLS][2]); //magic 07032012
		...
		//magic 09032012 begin
		//void OldToNew (TerrainObjectData *data, TerrainObjectDataOld *dataOld);
		//magic 09032012 end
