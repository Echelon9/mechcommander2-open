...
int CDisplayTextMessage::Execute()
{
	...
	if (MPlayer)
		...
		/* by mgto */
		//ControlGui::instance->setMessageText(0,m_message.Data());
		ControlGui::instance->setMessageText(1,m_message.Data()); //here to show paused message box set in mission editor
	//Magic 87 end
	//ControlGui::instance->setChatText("", m_message.Data(), 0xf0000000, 0); //Magic 87 disabled
	return true;
}
...
int CMakeNewSalvageComponents::Execute()
{
	LogisticsData::instance->addNewComponentSalvage( m_purchaseFilePathname );
	return true;
}
