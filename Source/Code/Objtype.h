...
class ObjectType {
	...
	public:
		...
		//Magic 88 begin
		long init (const char* mechName);
		long init (const char* objName, int myObjectType);
		virtual long init (FilePtr objFile, unsigned long fileSize, const char* vehicleName);
		//Magic 88 end
		...
		//Magic 89 begin
		void setObjectTypeClass(long typeClass) {
...
class ObjectTypeManager {
	...
	public:
		...
		static UserHeapPtr		objectTypeCache; //magic 25032012 disabled
		static UserHeapPtr		objectCache; //magic 25032012 disabled
	...
	public:
		...
		long init (char* objectFileName, long objectTypeCacheSize, long objectCacheSize, long maxObjectTypes = 4096);
		...
		//ObjectTypePtr load1 (ObjectTypeNumber objTypeNum, bool noCacheOut = true, bool forceLoad = false);
