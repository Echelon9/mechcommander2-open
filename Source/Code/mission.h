...
class Mission
{
	...
	public:
		...
		//magic 29012011 begin
		void tradeMover2 (MoverPtr mover, long newTeamID, long newCommanderID);
		//magic 29012011 end
		//magic 21052012 begin
		void removeMoverFromFG (MoverPtr mover);
		//magic 21052012 end
		...
		long setObjectiveStatus2 (long objectiveNum, ObjectiveStatus status); //objective_status_type newStatus); //magic 14042011
