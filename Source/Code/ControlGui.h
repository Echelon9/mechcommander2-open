...
class ControlGui
{
	public:
		...
		const char* getSupVehicleNameFromID (long ID); //magic 31032011
		...
		/* by mgto */ void setMessageText( int mode, const char* getString, int timeToDisplay = 20);
		/* by mgto */ EString i_text;
		//Magic 87 end
		//Magic 26112010 begin
		void setInstantMessageText( const char* getString, int timeToDisplay);
		//magic 26112010 end
	...
	private:
		...
		//Magic 87 begin - message box by rollin
		/* by mgto */ void renderMessageText (const char* getString);
		/* by mgto */ bool i_dispMsg;
		//Magic 87 end
		//magic 26112010 begin
