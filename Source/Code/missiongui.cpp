...
MissionInterfaceManager::Command		MissionInterfaceManager::commands[MAX_COMMAND] = { 
		KEY_S,				mState_SHRTRNG_ATTACK, mState_SHRTRNG_LOS,		false,		&MissionInterfaceManager::attackShort, &MissionInterfaceManager::defaultAttack, 43200, //0
		KEY_M,				mState_MEDRNG_ATTACK,  mState_MEDRNG_LOS,		false,		&MissionInterfaceManager::attackMedium, &MissionInterfaceManager::defaultAttack, 43201,//1
		KEY_L,				mState_LONGRNG_ATTACK, mState_LONGRNG_LOS,		false,		&MissionInterfaceManager::attackLong, &MissionInterfaceManager::defaultAttack, 43202,//2
		KEY_A,				mState_ENERGY_WEAPONS,	mState_ENERGY_WEAPONS_LOS,		false,		&MissionInterfaceManager::energyWeapons, &MissionInterfaceManager::energyWeapons, 43204,//3
		KEY_D,				mState_GENERIC_ATTACK, mState_ATTACK_LOS,		false,		&MissionInterfaceManager::defaultAttack,0, -1,//4
		KEY_J,				mState_JUMP1, mState_JUMP_LOS,		false,		&MissionInterfaceManager::jump, &MissionInterfaceManager::stopJump, 43205,//5
		KEY_J | WAYPT, 		mState_JUMPWAYPT,  mState_JUMPWAYPT_LOS,		false,		&MissionInterfaceManager::jump, &MissionInterfaceManager::stopJump, -1,//6
		KEY_C,				mState_CURPOS_ATTACK, mState_CURPOS_ATTACK_LOS,		false,		&MissionInterfaceManager::fireFromCurrentPos, &MissionInterfaceManager::stopFireFromCurrentPos, 43206,//7
		KEY_G,				mState_GUARD, mState_GUARD,				false,		&MissionInterfaceManager::guard, &MissionInterfaceManager::stopGuard, 43207,//8
		KEY_W,				mState_ENERGY_WEAPONS,	mState_ENERGY_WEAPONS_LOS,	false,		&MissionInterfaceManager::conserveAmmo, 0, -1,//9
		KEY_E,				-1,	-1,						false,		&MissionInterfaceManager::selectVisible, 0, 43209,//10
		KEY_F,				-1,	-1,						false,		&MissionInterfaceManager::forceShot, 0, 43210,//11
		KEY_HOME,				-1,	-1,						true,		&MissionInterfaceManager::cameraNormal,0, -1,//12
		KEY_F2,				-1,		-1,					true,		&MissionInterfaceManager::cameraDefault,0, -1,//13
		KEY_F3,				-1,		-1,					true,		&MissionInterfaceManager::cameraMaxIn,0, -1,//14
		KEY_F4,				-1,		-1,					true,		&MissionInterfaceManager::cameraTight,0, -1,//15
		KEY_F5,				-1,		-1,					true,		&MissionInterfaceManager::cameraFour,0, -1,//16
		KEY_F2 | CTRL,		-1,		-1,					true,		&MissionInterfaceManager::cameraAssign0,0, -1,//17
		KEY_F3 | CTRL, 		-1,		-1,					true,		&MissionInterfaceManager::cameraAssign1,0, -1,//18
		KEY_F4 | CTRL, 		-1,		-1,					true,		&MissionInterfaceManager::cameraAssign2,0, -1,//19
		KEY_F5 | CTRL, 		-1,		-1,					true,		&MissionInterfaceManager::cameraAssign3,0, -1,//20
		KEY_NUMPAD2,		mState_DONT, mState_AIMED_ATTACK_LOS,		false,		&MissionInterfaceManager::aimLeg, 0, 43211,//21
		KEY_NUMPAD5,		mState_DONT,  mState_AIMED_ATTACK_LOS,		false,		&MissionInterfaceManager::aimArm, 0, 43212,//22
		KEY_NUMPAD8,		mState_DONT,  mState_AIMED_ATTACK_LOS,		false,		&MissionInterfaceManager::aimHead, 0, 43213,//23
		KEY_BACK,	-1, -1,							false,		&MissionInterfaceManager::removeCommand, 0, 43214,//24
		KEY_NEXT | 0x100,	-1,	-1,						false,		&MissionInterfaceManager::powerDown, 0, 43215,//25
		KEY_PRIOR| 0x100,	-1,	-1,						false,		&MissionInterfaceManager::powerUp, 0, 43216,//26
		KEY_END| 0x100,	mState_EJECT, mState_EJECT,		false,		&MissionInterfaceManager::eject, 0, 43217,//27
		KEY_SPACE, 			mState_RUN,	 mState_RUN_LOS,				false,		&MissionInterfaceManager::changeSpeed, &MissionInterfaceManager::stopChangeSpeed, 43218,//28
		KEY_SPACE | WAYPT, 	mState_RUNWAYPT, 	 mState_RUNWAYPT_LOS,					false,		&MissionInterfaceManager::changeSpeed, &MissionInterfaceManager::stopChangeSpeed, -1,//29
		KEY_UP | 0x100,				-1,	-1,						false,		&MissionInterfaceManager::scrollUp, 0,  IDS_HOTKEY_TRACKU,//30
		KEY_DOWN | 0x100,			-1,	-1,						false,		&MissionInterfaceManager::scrollDown, 0, IDS_HOTKEY_TRACKD,//31
		KEY_LEFT | 0x100,			-1,	-1,						false,		&MissionInterfaceManager::scrollLeft, 0, IDS_HOTKEY_TRACKL,//32
		KEY_RIGHT | 0x100,	 		-1,	-1,						false,		&MissionInterfaceManager::scrollRight, 0, IDS_HOTKEY_TRACKR,//33
		KEY_SUBTRACT,		-1,	-1,						false,		&MissionInterfaceManager::zoomOut,0, 43225,//34
		KEY_MINUS,			-1,	-1,						false,		&MissionInterfaceManager::zoomOut,0, -1,//35
		KEY_ADD,			-1,	-1,						false,		&MissionInterfaceManager::zoomIn,0, 43224,//36
		SHIFT | KEY_EQUALS,			-1,	-1,				false,		&MissionInterfaceManager::zoomIn,0, -1,//37
		KEY_LEFT | SHIFT | 0x100, 	-1,	-1,						false,		&MissionInterfaceManager::rotateLeft, 0, IDS_HOTKEY_ROTATEL,//38
		KEY_RIGHT | SHIFT | 0x100,	-1,	-1,						false,		&MissionInterfaceManager::rotateRight, 0, IDS_HOTKEY_ROTATER,//39
		KEY_UP | SHIFT | 0x100,	-1,	-1,						false,		&MissionInterfaceManager::tiltUp, 0, IDS_HOTKEY_TILTU,//40
		KEY_DOWN | SHIFT | 0x100,		-1,	-1,						false,		&MissionInterfaceManager::tiltDown, 0, IDS_HOTKEY_TILTD,//41
		KEY_HOME | 0x100,			-1,	-1,						false,		&MissionInterfaceManager::centerCamera, 0, -1,//42
		KEY_LEFT | CTRL,	-1,	-1,						false,		&MissionInterfaceManager::rotateLightLeft, 0, -1,//43
		KEY_RIGHT | CTRL,	-1,	-1,						false,		&MissionInterfaceManager::rotateLightRight, 0, -1,//44
		KEY_UP | CTRL,		-1,	-1,						false,		&MissionInterfaceManager::rotateLightUp, 0, -1,//45
		KEY_DOWN | CTRL,	-1,	-1,						false,		&MissionInterfaceManager::rotateLightDown, 0, -1,//46
		KEY_T | CTRL | ALT, -1,	-1,						true,		&MissionInterfaceManager::drawTerrain, 0, -1,//47
		KEY_O | CTRL | ALT, -1,	-1,						true,		&MissionInterfaceManager::drawOverlays, 0, -1,//48
		KEY_B | CTRL | ALT, -1,	-1,						true,		&MissionInterfaceManager::drawBuildings, 0, -1,//49
		CTRL | ALT | KEY_G, -1,	-1,						true,		&MissionInterfaceManager::showGrid, 0, -1,//50
		CTRL | ALT | KEY_Q, -1,	-1,						true,		&MissionInterfaceManager::recalcLights, 0, -1,//51 
		CTRL | ALT | KEY_C, -1,	-1,						true,		&MissionInterfaceManager::drawClouds, 0, -1,//52
		CTRL | ALT | KEY_F, -1,	-1,						true,		&MissionInterfaceManager::drawFog, 0, -1,//53
		CTRL | ALT | KEY_P, -1,	-1,						true,		&MissionInterfaceManager::usePerspective, 0, -1,//54
		CTRL | ALT | KEY_S, -1,	-1,						true,		&MissionInterfaceManager::drawTGLShapes, 0, -1,//55
		CTRL | ALT | KEY_V, -1,	-1,						true,		&MissionInterfaceManager::drawWaterEffects, 0, -1,//56
		CTRL | ALT | KEY_W, -1,	-1,						true,		&MissionInterfaceManager::recalcWater, 0, -1,//57
		CTRL | ALT | KEY_D, -1,	-1,						true,		&MissionInterfaceManager::drawShadows, 0,  -1,//58
		CTRL | ALT | KEY_L, -1,	-1,						true,		&MissionInterfaceManager::changeLighting, 0, -1,//59
		CTRL | ALT | KEY_Z, -1,	-1,						true,		&MissionInterfaceManager::toggleGUI, 0, -1,//60
		KEY_V,				-1,	-1,						true,		&MissionInterfaceManager::vehicleCommand, 0, 43222,//61
		KEY_F9,			-1,	-1,						true,		&MissionInterfaceManager::showObjectives, 0, 43226,//61
		KEY_ESCAPE,			-1,	-1,						true,		&MissionInterfaceManager::togglePause, 0, 43234,//63
		KEY_F1,				-1,	-1,					true,		&MissionInterfaceManager::toggleHotKeys, 0, -1,//64
		KEY_P,			-1,	-1,						true,		&MissionInterfaceManager::togglePause, 0, -1,//65
		KEY_TAB,			-1,	-1,						true,		&MissionInterfaceManager::switchTab, 0, -1,//66
		KEY_TAB | SHIFT,	-1,	-1,						true,		&MissionInterfaceManager::reverseSwitchTab, 0, -1,//67
		KEY_I,				-1, -1,						true,		&MissionInterfaceManager::infoCommand, &MissionInterfaceManager::infoButtonReleased, 43219,//68
		KEY_N,				-1, -1,						true,		&MissionInterfaceManager::gotoNextNavMarker, 0, -1,//69
		KEY_MULTIPLY,  mState_UNCERTAIN_AIRSTRIKE, mState_AIRSTRIKE, true, &MissionInterfaceManager::sendAirstrike, 0, 43220,//70
		KEY_DIVIDE, 		mState_SENSORSTRIKE, mState_SENSORSTRIKE, true, &MissionInterfaceManager::sendSensorStrike, 0, 43221,//71
		KEY_BACKSLASH,		-1, -1,				true,		&MissionInterfaceManager::toggleCompass, 0, 43223,//72
		ALT | KEY_SLASH,	-1, -1,						false,		&MissionInterfaceManager::quickDebugInfo, 0, -1,//73
		ALT | SHIFT | KEY_SLASH, -1, -1,				false,		&MissionInterfaceManager::setGameObjectWindow, 0, -1,//74
		ALT | CTRL | KEY_1, -1, -1,					false,		&MissionInterfaceManager::pageGameObjectWindow1, 0, -1,//75
		ALT | CTRL | KEY_2, -1, -1,					false,		&MissionInterfaceManager::pageGameObjectWindow2, 0, -1,//76
		ALT | CTRL | KEY_3, -1, -1,					false,		&MissionInterfaceManager::pageGameObjectWindow3, 0, -1,//77
		ALT | KEY_1,		-1,	-1,						false,		&MissionInterfaceManager::jumpToDebugGameObject1, 0, -1,//78
		ALT | KEY_2,		-1,	-1,						false,		&MissionInterfaceManager::jumpToDebugGameObject2, 0, -1,//79
		ALT | KEY_3,		-1,	-1,						false,		&MissionInterfaceManager::jumpToDebugGameObject3, 0, -1,//80
 		ALT | KEY_T,		-1, -1,						false,		&MissionInterfaceManager::teleport, 0, -1,//81
		ALT | KEY_W,		-1,	-1,						false,		&MissionInterfaceManager::toggleDebugWins, 0, -1,//82
		ALT | KEY_M,		-1,	-1,						false,		&MissionInterfaceManager::showMovers, 0, -1,//83
		ALT | KEY_C,		-1,	-1,						false,		&MissionInterfaceManager::cullPathAreas, 0, -1,//84
		ALT | KEY_Z,		-1,	-1,						false,		&MissionInterfaceManager::zeroHPrime, 0, -1,//85
		ALT | KEY_A,		-1,	-1,						false,		&MissionInterfaceManager::calcValidAreaTable, 0, -1,//86
		ALT | KEY_G,		-1,	-1,						false,		&MissionInterfaceManager::globalMapLog, 0, -1,//87
		ALT | KEY_B,		-1,	-1,						false,		&MissionInterfaceManager::brainDead, 0, -1,//88
		ALT | KEY_P,		-1,	-1,						false,		&MissionInterfaceManager::goalPlan, 0, -1,//89
		ALT | KEY_V,		-1,	-1,						false,		&MissionInterfaceManager::showVictim, 0, -1,//90
		ALT | CTRL | KEY_P,	-1, -1,						false,		&MissionInterfaceManager::enemyGoalPlan, 0, -1,//91
		ALT | KEY_4,	-1, -1,					false,		&MissionInterfaceManager::damageObject1, 0, -1,//92
		ALT | KEY_5,	-1, -1,					false,		&MissionInterfaceManager::damageObject2, 0, -1,//93
		ALT | KEY_6,	-1, -1,					false,		&MissionInterfaceManager::damageObject3, 0, -1,//94
		ALT | KEY_7,	-1, -1,					false,		&MissionInterfaceManager::damageObject4, 0, -1,//95
		ALT | KEY_8,	-1, -1,					false,		&MissionInterfaceManager::damageObject5, 0, -1,//96
		ALT | KEY_9,	-1, -1,					false,		&MissionInterfaceManager::damageObject6, 0, -1,//97
		ALT | KEY_0,	-1, -1,					false,		&MissionInterfaceManager::damageObject0, 0, -1,//98
		...
		KEY_H,				-1, -1,						true,		&MissionInterfaceManager::toggleHoldPosition, 0, -1,//99
		KEY_RETURN,			-1, -1,						true,		&MissionInterfaceManager::handleChatKey, 0, IDS_HOTKEY_CHAT,//100
		SHIFT | KEY_RETURN,	-1, -1,				true,		&MissionInterfaceManager::handleTeamChatKey, 0, IDS_HOTKEY_CHAT_TEAM,//101
		KEY_E | SHIFT,				-1,	-1,						false,		&MissionInterfaceManager::addVisibleToSelection, 0, -1,//102
		KEY_EQUALS,			-1,	-1,				false,		&MissionInterfaceManager::zoomIn,0, -1,//103
		ALT | KEY_PERIOD, -1, -1,						false, &MissionInterfaceManager::rotateObjectLeft, 0, -1,//104
		ALT | KEY_COMMA, -1, -1,				false,	&MissionInterfaceManager::rotateObjectRight, 0, -1,//105
		KEY_PAUSE,		-1, -1,						true,		&MissionInterfaceManager::togglePause, 0, -1,//106
		//Magic 80 begin
		KEY_K,				-1, -1,	false,	&MissionInterfaceManager::cycleFormations, 0, 45232,
		//KEY_K,				-1,	-1,						false,		&MissionInterfaceManager::forceShot, 0, 43210//107
		//Magic 80 end
};
			...
			if (vehicleID[vtolNum] != 147)		//We are the standard vtol.
			{
				...
				else if (vTol[vtolNum]->currentFrame >= 300)
				{
					...
					else if (reinforcement)
					{
						...
						//Magic 82 begin
						controlGui.forceGroupBar.sortForceGroup();
						//Magic 82 end
						reinforcement = NULL;
					}
											 ...
											 long moverCount, long nonMoverCount )
{
	...
	//printDebugInfo(); //magic 06032012 disabled
...
//Magic 85 begin
		if (userInput->getKeyDown(KEY_K) && gos_GetKeyStatus(KEY_K) != KEY_HELD )
		{
			formationID++;
			if (formationID > 5)
				formationID = 0;
			//magic 26112010 begin
			//mission->missionInterface->setTutorialText("formation change");
			//MessageBox(NULL,"Formation change","TEST",MB_OK);
			//controlGui.setChatText("PROBA","FORMATION LINE", 0x00ffffff, 0 );
			//controlGui.setMessageText("PROBA");
			//controlGui.toggleChat(true);
			//controlGui.renderChatText();
			switch (formationID)
			{
				case 0:
					controlGui.setMessageText(0,"FORMATION LINE",10);
					break;
				case 1:
					controlGui.setMessageText(0,"FORMATION WEDGE",10);
					break;
				case 2:
					controlGui.setMessageText(0,"FORMATION ARROW",10);
					break;
				case 3:
					controlGui.setMessageText(0,"FORMATION COLUMN",10);
					break;
				case 4:
					controlGui.setMessageText(0,"FORMATION DOUBLE LINE",10);
					break;
				case 5:
					controlGui.setMessageText(0,"FORMATION DOUBLE COLUMN",10);
					
			}
			//magic 26112010 end not working because it shows this for a second and then normatl help text
		}
	/*//Magic Debug file begin
	char tmp2[256];
	FitIniFile MtestFile;
	//MtestFile.open("data\\formations_test.fit", CREATE);
	MtestFile.open("data\\formations_cycletest.fit", CREATE);
	sprintf( tmp2, "formationID %ld", formationID );
...
int MissionInterfaceManager::handleOrders( TacticalOrder& order)
{
	...
	if (order.code == TACTICAL_ORDER_JUMPTO_POINT) {
		...
		//Magic 84 begin
		long pWatchIDIndex[16];
		long rosterIndexList[16];

		float ofsetAngle = 0;
		
		//Magic 84 end
		long numUnitsRoster = pTeam->getRosterSize();
		//for (long i = 0; i < pTeam->getRosterSize(); i++)
		int k = 0;
		for (long i = 0; i < numUnitsRoster; i++)
		{			
			Mover* pMover = pTeam->getMover(i);
			if (pMover->isSelected() && pMover->getCommander()->getId() == Commander::home->getId())
			{
				numMovers++;
				//Magic 84 begin
				pWatchIDIndex[k] = pMover->getWatchID();
				rosterIndexList[k] = pMover->getTeamRosterIndex();
				k++;
				//Magic 84 end
			}
		}
		...
		//Magic 86 begin
		normalizeIndexes(rosterIndexList,numMovers);
		//magic 86 end
	...
	char tmp2[256];
	FitIniFile MtestFile;
	MtestFile.open("data\\missiongui_test.fit", CREATE);
	sprintf( tmp2, "numMovers %ld", numMovers );
	MtestFile.writeBlock( tmp2 );

	sprintf( tmp2, "leastIndex %ld", minIndex );
	MtestFile.writeBlock( tmp2 );

	for (int i = 0; i < numMovers; i++)
	{
		sprintf( tmp2, "pWatchIDIndex %ld", pWatchIDIndex[i] );
		MtestFile.writeBlock( tmp2 );
	}

	for (int i = 0; i < numMovers; i++)
	{
		sprintf( tmp2, "rosterIndexList %ld", rosterIndexList[i] );
		MtestFile.writeBlock( tmp2 );
	}

	for (int i = 0; i < numMovers; i++)
	{
		sprintf( tmp2, "x__ %ld", (long)moveGoals[i].x );
		MtestFile.writeBlock( tmp2 );
		sprintf( tmp2, "y__ %ld", (long)moveGoals[i].y );
		MtestFile.writeBlock( tmp2 );
		sprintf( tmp2, "z__ %ld", (long)moveGoals[i].z );
		MtestFile.writeBlock( tmp2 );
	}
	...
	//Magic debug file end*/
		...
		{	
			//Magic 90 begin
			long leastSelectionIndex = least1DArrayIndex(rosterIndexList,numMovers);
			//Magic 90 end
			Mover* pMover = pTeam->getMover(i);
			if (pMover->isSelected() && pMover->getCommander()->getId() == Commander::home->getId())
				//ofsetAngle += world_angle_between(pMover->getPosition(),moveGoals[0]);//Magic 90 disabled
				//Magic 90 begin
				if (rosterIndexList[leastSelectionIndex] == pMover->getTeamRosterIndex())
					ofsetAngle = world_angle_between(pMover->getPosition(),moveGoals[0]);
				//Magic 90 end
		}
		//ofsetAngle /= numMovers; //Magic 90 disabled

		formations(moveGoals, numMovers, ofsetAngle);
		//Magic 84 end
		//Magic 85 begin
		Stuff::Vector3D newMoveGoals[16];
		for (int i = 0; i < numMovers; i++)
			newMoveGoals[i] = moveGoals[rosterIndexList[i]];

		for (int i = 0; i < numMovers; i++)
			moveGoals[i] = newMoveGoals[i];
...
bool MissionInterfaceManager::canRecover( const Stuff::Vector3D& pos )
{
		 ...
		 && tileI > -1 && tileI < land->realVerticesMapSide )
	{
		if ( Team::home->teamLineOfSight(pos, 0.0f) )
		{
			...
			if ( target && (target->getObjectClass() == BATTLEMECH) && target->isDisabled() && !target->isDestroyed() && ((MapData::waterDepth - target->getPosition().z) < 100.f) ) //magic 25092012
				return true;
			else 
				return false;
		}	
...
long MissionInterfaceManager::makeTargetCursor( bool lineOfSight, long moverCount, long nonMoverCount)
{
	...
	else if ( controlGui.getRepair() )
	{
		...
		//magic 06072011 begin
			//if (target->getResourcePoints() > 0)
			//if (target->getResPoints() > 0) //magic 02082011
			if (target->getResourcePoints() > 20.0f) //magic 02082011
			{
				//currentCursor = mState_LINK;
				currentCursor = mState_TUTORIALS;
				//controlGui.setRolloverHelpText( IDS_STRING30962 ); //Truck Empty NO good
			}
			else
		//magic 06072011 end
...
MoverPtr BringInReinforcement (long vehicleID, long rosterIndex, long commanderID, Stuff::Vector3D pos, bool exists) {
	...
	vehicleFile = (char*)MissionInterfaceManager::instance()->getSuppVehicleNameFromID(vehicleID);
	strcpy( data.csvFileName, vehicleFile );
	//magic 31032011 end
...
void MissionInterfaceManager::beginVtol (long supportID, long commanderID, Stuff::Vector3D* reinforcePos, MoverPtr salvageTarget)
{
	...
	if (commanderID == Commander::home->getId())
	{
		...
		{
			//case 120:	//Minelayer
			case 2033:	//Minelayer //magic 15072011
				soundSystem->playSupportSample(SUPPORT_MINELAYER);
			break;

			//case 182:	//Repair
			case 2067:	//Repair //magic 15072011
				soundSystem->playSupportSample(SUPPORT_REPAIR);
			//magic 15072011 begin
				//if ( (ID == REPAIR_VEHICLE) && !paintingMyVtol )
					LogisticsData::instance->toggleRepairTruck( );
			//magic 15072011 end //NO GOOD here 
			break;

			//case 393:	//Scout
			case 1283:	//Scout //magic 15072011
			...
			//case 415:	//Artillery
			case 2034:	//Artillery //magic 15072011
...
//		target->getObjectClass() == BATTLEMECH ) ? 1 : 0;
	...
	return (controlGui.forceGroupBar.getIconCount() < MAX_ICONS
		&& target->isDisabled() && lineOfSight && 
		target->getObjectClass() == BATTLEMECH && ((MapData::waterDepth - target->getPosition().z) < 100.f) ) ? 1 : 0; //magic 25092012
...
bool MissionInterfaceManager::canRepair( GameObject* pMover )
{
	if ( !pMover )
		return 0;
	//magic 08072011 begin
	//if ( !pMover->isMover() && ((pMover->getResourcePoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 0))) //magic 07072011
	if ( !pMover->isMover() && ((pMover->getResPoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 20))) //magic 02082011
	//if ( !pMover->isMover() && ((pMover->getResourcePoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 20))) //magic 08092012
		return true;
	//magic 08072011 end 
	if ( !pMover->isMover() )
		return 0;
	...
	if (pMover->isDisabled() || pMover->isDestroyed())
		return 0;
	//magic 05072011 begin
	//if ((pMover->getResourcePoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) )
	//if ((pMover->getResourcePoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 0)) //magic 06072011
	if ((pMover->getResPoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 20)) //magic 02082011
	//if ((pMover->getResourcePoints() > 0) &&  !Team::home->isEnemy( pMover->getTeam()) && (LogisticsData::instance->getResourcePoints() > 20)) //magic 08092012
	{
		return true;
	}
	//magic 05072011 end
...
void MissionInterfaceManager::formations(Stuff::Vector3D* moveGoals, long numMovers, float ofsetAngle)
{
	float leftDist = 20;
	float rightDist = 20;
	...
	switch (formationID)
	{
		case 0:
			/*char tmp2[64];
			sprintf( tmp2, "Formation No: %ld", formationID );
			MessageBox(NULL,tmp2,"TEST",MB_OK);*/
			for (int i = 1; i < numMovers; i++)
			{
				if (leftDist > rightDist)
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], 90 + ofsetAngle, rightDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					rightDist += 15;
				}
				else
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], -90 + ofsetAngle, leftDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					leftDist += 15;
		...
		case 1:
			...
			for (int i = 1; i < numMovers; i++)
			{
				...
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], 45 + ofsetAngle, rightDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					rightDist += 20;
				...
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], -45 + ofsetAngle, leftDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					leftDist += 20;
		...
		case 2:
			...
			for (int i = 1; i < numMovers; i++)
			{
				...
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], 135 + ofsetAngle, rightDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					rightDist += 15;
				...
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], -135 + ofsetAngle, leftDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					leftDist += 15;
		...
		break;
 		...
 		case 3:
			...
			for (int i = 1; i < numMovers; i++)
			{
				...
				//{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], 180 + ofsetAngle, rightDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					rightDist += 15;
				...
				{
					Stuff::Vector3D newPos;
					newPos = relPositionToPoint(moveGoals[0], 180 + ofsetAngle, leftDist, 2); //2);
					moveGoals[i].x = newPos.x;
					moveGoals[i].y = newPos.y;
					moveGoals[i].z = newPos.z;
					leftDist += 10;
    	...
    	case 4:
			...
			for (int i = 1; i < numMovers; i++)
			{
				...
				{
						Stuff::Vector3D newPos;
						newPos = relPositionToPoint(moveGoals[i - divLine], 180 + ofsetAngle, 20.0f, 2); //2);
						moveGoals[i].x = newPos.x;
						moveGoals[i].y = newPos.y;
						moveGoals[i].z = newPos.z;
				}
...
Stuff::Vector3D MissionInterfaceManager::relPositionToPoint (Stuff::Vector3D pointPos, float angle, float distance, unsigned long flags) {
	...
	Stuff::Vector3D curPos(pointPos.x, pointPos.y, 0.0);
...
int MissionInterfaceManager::cycleFormations()
{
	/*MessageBox(NULL,"cycle formations","TEST",MB_OK);
		if (gos_GetKeyStatus(KEY_K) != KEY_HELD )
		{
			formationID++;
			if (formationID > 5)
				formationID = 0;
...
void MissionInterfaceManager::setTextMsg (long msgType, const char* msgText, long msgSeconds)
{
	controlGui.setMessageText(msgType, msgText, msgSeconds);
}

//Helper functions
//--------------------------------------------------------------------------------------
void normalizeIndexes(long* indexList, long numInd)
{
	long pomIndex[16];
	bool all99 = false;
	long leastIndex = 0;
	...
	for (int i = 0; i < numInd; i++)
		pomIndex[i] = indexList[i];

	while (!all99)
	{
		leastIndex = least1DArrayIndex(pomIndex,numInd);
		if (pomIndex[leastIndex] < 99)
		{
			indexList[leastIndex] = j;
			j++;
			pomIndex[leastIndex] = 99;
		}
		else
			all99 = true;
	...
	char tmp2[256];
	FitIniFile MtestFile;
	MtestFile.open("data\\normalize_test.fit", CREATE);
	sprintf( tmp2, "numInd %ld", numInd );
	MtestFile.writeBlock( tmp2 );

	sprintf( tmp2, "j__ %ld", j );
	MtestFile.writeBlock( tmp2 );

	for (int i = 0; i < numInd; i++)
	{
		sprintf( tmp2, "pomIndex %ld", pomIndex[i] );
		MtestFile.writeBlock( tmp2 );
	}

	for (int i = 0; i < numInd; i++)
	{
		sprintf( tmp2, "indexList %ld", indexList[i] );
		MtestFile.writeBlock( tmp2 );
	}
...
long least1DArrayIndex(long* indexList, long numInd)
{
	long minValue = indexList[0];
	long minIndex = 0;
	for (int i = 0; i < numInd; i++)
		if (indexList[i] < minValue)
		{
			minValue = indexList[i];
			minIndex = i;
		}
	return minIndex;
