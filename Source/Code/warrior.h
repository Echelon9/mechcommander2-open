...
#define	MAX_WARRIORS				160 //200 //120 //magic 06082011
...
#define	MAX_QUEUED_TACORDERS				5200 //2000 (must be > MAX_WARRIORS*MAX_QUEUED_TACORDERS_PER_WARRIOR)
#define	MAX_QUEUED_TACORDERS_PER_WARRIOR	32 //16 magic 06082011
...
typedef enum {
	...
	//Magic78 SENSOR_SPECIALIST, // Magic obsolete as of 20.09.2010.
	...
	LRM_SPECIALIST,
	SCOUT,
	//Magic78 LONG_JUMP,	//Magic obsolete as of 20.09.2010.
...
#define FIRST_VETERAN_SPECIALTY	7//Magic78 was 8
#define FIRST_ELITE_SPECIALTY 12 //Magic78 was 14
#define FIRST_ACE_SPECIALTY	18 //Magic78 was 20
...
class TargetPriorityList {
	...
	public:
		...
		//void* operator new (size_t ourSize); //magic 30092011 disabled

		//void operator delete (void* us); //magic 30092011 disabled
...
#define MAX_GLOBAL_PATH			200 //magic 06032012
...
typedef struct _QueuedTacOrder 
{
	...
	unsigned char				action; //tacorder code
	//magic 12022012 end*/
} QueuedTacOrder;
...
class MechWarrior {
	...
	public:
		...
		{
			return (specialtySkills[7] == 1); //magic 79 was 8
		}
		...
		{
			return (specialtySkills[6] == 1);//magic 79 was 7
		}

		bool isHevayMechSpecialist (void)			//DONE
		{
			return (specialtySkills[12] == 1);//magic 79 was 14
		}

		bool isPulseLaserSpecialist (void)			//DONE
		{
			return (specialtySkills[8] == 1);//magic 79 was 9
		}

		bool isERLaserSpecialist (void)				//DONE
		{
			return (specialtySkills[9] == 1);//magic 79 was 10
		}

		bool isLRMSpecialist (void)					//DONE
		{
			return (specialtySkills[10] == 1);//magic 79 was 11
		}

		bool isPPCSpecialist (void)					//DONE
		{
			return (specialtySkills[13] == 1);//magic 79 was 15
		}

		bool isScout (void)
		{
			return (specialtySkills[11] == 1);//magic 79 was 12
		}

		/* Magic 79 obsolete
		bool isLongJump (void)
		{
			return (specialtySkills[13] == 1);//Magic 79 obsolete
		}*/

		bool isAssaultMechSpecialist (void)			//DONE
		{
			return (specialtySkills[18] == 1);//magic 79 was 20
		}
	
		bool isGaussSpecialist (void)				//DONE
		{
			return (specialtySkills[19] == 1);//magic 79 was 21
		}

		bool isHeavyACSpecialist (void)				//DONE
		{
			return (specialtySkills[14] == 1);//magic 79 was 16
		}

		bool isShortRangeSpecialist (void)			//DONE
		{
			return (specialtySkills[15] == 1);//magic 79 was 17
		}

		bool isMediumRangeSpecialist (void)			//DONE
		{
			return (specialtySkills[16] == 1);//magic 79 was 18
		}

		bool isLongRangeSpecialist (void)			//DONE
		{
			return (specialtySkills[17] == 1);//magic 79 was 19
		}
		...
		*/
		...
		{
			return (specialtySkills[20] == 1);//magic 79 was 22
		}

		/* Magic 79 obsolete
		bool isSensorProfileSpecialist (void)
		{
			return (specialtySkills[6] == 1);//magic 79 obsolete
		}*/
		...
		//Magic 81 begin
		const char* getSpecSkillText( int skillID );
		//Magic 81 end
...
//		void setUnit (MoverGroupPtr _group, long _unitMateId);
		...
		bool isJumping (MoverPtr myVehicle);
		...
		/*//Magic 23112010 begin
		long magicAttack (GameObjectPtr target, unsigned long params = 0);
		GameObjectPtr findClosestTarget (GameObjectPtr target, float range);
		//magic 23112010 end*/
