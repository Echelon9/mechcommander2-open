...
class LogisticsPilot
{
	public:
		...
		float			getSensorSkill() const { return sensorSkill; }//Magic 55
		float			getJumping() const { return jumping; }//Magic 55
		...
		int			getNewSensorSkill() const { return newSensorSkill; }//Magic 55
		int			getNewJumping() const { return newJumping; }//Magic 55
		void		setDead();
	...
	private:
		...
		float			gunnery;
		float			piloting;
		float			sensorSkill;//Magic 55
		float			jumping;//Magic 55
		long			mechKills;
		long			vehicleKills;
		long			infantryKills;
		...
		float			newPiloting;
		float			newGunnery;
		float			newSensorSkill;//Magic 55
		float			newJumping;//Magic 55
