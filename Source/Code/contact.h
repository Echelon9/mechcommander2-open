...
class ContactInfo {
	...
	public:
		...
		//void* operator new (size_t mySize);  //magic 30092011 disabled
...
class SensorSystem {
	...
	public:
		...
		/*//magic 13022012 begin
		void setHasProbe (bool index) {
			hasProbe = index;
		}
		bool getHasProbe (void) {
			return hasProbe;
		}
		//magic 13022012 end*/
		...
		bool inFriendlyECMRange (MoverPtr mover); //magic 16022012

		bool isContact (MoverPtr mover);

		void addContact (MoverPtr mover, bool visual);

		void addContact (MoverPtr mover, bool visual, bool hasProbe); //magic 13022012

		void modifyContact (MoverPtr mover, bool visual);

		void modifyContact (MoverPtr mover, bool visual, bool hasProbe); //magic 13022012
		...
		MoverPtr getMoverPointer (void); //Magic 53
		MoverPtr scanNewContact (void); //Magic 53
		//bool scanNewContact2 ();//long* myMover);//Magic 54
		long scanNewContact3 (long* myMover);//Magic 55
